...
function PricingTable() {
  return (
    <div className="container mt-5 px-2 px-md-3">
      ...
      {/* Nav Tabs */}
      <ul
        className="nav nav-tabs justify-content-center border-0 mb-4 mb-md-5 p-2 p-md-3 flex-nowrap overflow-auto"
        id="pricingTab"
        role="tablist"
      ...
      >
        <li className="nav-item" role="presentation">
          <button
            className="nav-link active fs-5 fs-md-4 px-3 px-md-4"
            id="equity-tab"
            data-bs-toggle="tab"
        ...
        <li className="nav-item" role="presentation">
          <button
            className="nav-link fs-5 fs-md-4 px-3 px-md-4"
            id="currency-tab"
            data-bs-toggle="tab"
